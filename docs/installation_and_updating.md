...
## Installation
1. Download and install Blender 5.2 (the current LTS version) from the official website: [https://www.blender.org/download/releases/5-2/](https://www.blender.org/download/releases/5-2/)
