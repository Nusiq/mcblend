...
def set_scene_mcblend_active_event(context: Context, value: int) ->\
    None: ...

def set_use_clamp(obj: Node, use_clamp: bool) -> None: ...

def set_uv(obj: MeshUVLoop, uv: tuple[float, float] | np.ndarray) -> None: ...
...
@overload
def to_euler(obj: Matrix, order: str, euler_compact: None | Euler=None): ...
