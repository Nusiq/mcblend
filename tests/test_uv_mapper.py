...
def make_comparison_files(
    ...
    '''
    Opens blender file, selects scene, maps UV, and exports model from that to
    given tmp path.
    ...
    expected_result_path = (
        f'./tests/data/test_uv_mapper/{scene_name}.geo.json'
    )

    script = os.path.abspath('./blender_scripts/uv_map_and_export_model.py')
